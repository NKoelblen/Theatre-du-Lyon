...
(function (wp, $) {
    $( function($) {
      ...
      $('input[data-customize-setting-link="tc_theme_options[tc_disable_google_fonts]"]').change(function(e){
            if( $(this).prop('checked') ){
                  $('.wp-customizer').addClass('remove_google_fonts');
                  api( api.CZR_Helpers.build_setId( 'tc_fonts' ) ).set('impact_palatino');
      ...
      if( $('input[data-customize-setting-link="tc_theme_options[tc_disable_google_fonts]"]').prop('checked') ){
            $('.wp-customizer').addClass('remove_google_fonts');
            api( api.CZR_Helpers.build_setId( 'tc_fonts' ) ).set('impact_palatino');
            var font_title = $('select[data-customize-setting-link="tc_theme_options[tc_fonts]"] option:selected').text();
            $('select[data-customize-setting-link="tc_theme_options[tc_fonts]"]').next('.selecter').find('.selecter-selected').html( font_title );
      }
