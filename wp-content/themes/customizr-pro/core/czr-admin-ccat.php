      ...
      function czr_fn_welcome_panel() {
        ...
        <div class="customizr-admin-panel">
            ...
            <?php
              if ( !CZR_IS_PRO ) {
                printf( '<h3>%1$s ❤️.</h3><h4>%2$s</h4><h4>%3$s 🙏</h4><h4 style="font-weight:bold">%4$s</h4>',
                  sprintf( __( "If you enjoy using the Customizr theme for your website, you will love %s", "customizr-pro"),
                    sprintf( '<a style="color:#d87f00" href="%1$s" title="%2$s" target="_blank" rel="noopener noreferrer">%2$s</a>', 'https://presscustomizr.com/customizr-pro/', __("Customizr Pro", "customizr-pro") )
                  ),
                  __("With Customizr Pro, you get premium features like infinite scrolling, footer and header customization, font customizer and many more. In addition, our premium support will be there to help you resolve any issue you may have with the theme. When installing Customizr Pro, all your previous options used in Customizr free are kept.", 'customizr-pro'),
                  __('And of course your support allows us to keep the theme at the highest level for your website. Thank you!', 'customizr-pro'),
          ...
          <div class="czr-col-50 first-col">
            <h3 style="font-size:1.3em;"><?php _e( 'Knowledge base','customizr-pro' ); ?></h3>
            <p><?php _e( "We have prepared a complete online documentation of the theme.",'customizr-pro' ) ?></br>
            <a class="button-primary review-customizr" href="<?php echo 'https://docs.presscustomizr.com/' ?>" target="_blank"><?php _e('Customizr Documentation','customizr-pro'); ?></a></p>
            <!-- Place this tag where you want the widget to render. -->
          </div>
          
          <div class="czr-col-50">
            <h3 style="font-size:1.3em;"><?php _e( 'Share your feedback','customizr-pro' ); ?></h3>
            <p><?php _e( 'If you are happy with the theme, say it on wordpress.org and give Customizr a nice review!','customizr-pro' ) ?></br>
            <a class="button-primary review-customizr" href="<?php echo esc_url('wordpress.org/support/view/theme-reviews/customizr') ?>" target="_blank"><?php _e('Share a review','customizr-pro'); ?></a></p>
          </div>
       ...
       */
        function czr_fn_get_attachment_slider_infos( $postid ) {
         ...
         if ( $slider_check_value == true )  {
           ...
           <div class="meta-box-item-title">
               <h4><?php _e("Open link in a new browser tab", 'customizr-pro' );  ?></h4>
           </div>
           <div class="meta-box-item-content">
               <?php
                  CZR_meta_boxes::czr_fn_checkbox_view( array(
